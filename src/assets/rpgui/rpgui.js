RPGUI = (function () {
  ...
  RPGUI.create = function (element, rpgui_type) {
    ...
    // not a valid type? exception.
      ...
      throw (
        "Not a valid rpgui type! options: " + Object.keys(RPGUI.__create_funcs)
      );
    }
  };
  ...
  function create_progress(elem) {
    ...
    if (RPGUI.has_class(elem, "purple")) {
    ...
    RPGUI.set_value(progress, 0.7);

    var progress = document.getElementById("sleep-bar");
    RPGUI.set_value(progress, 0.2);

    var progress = document.getElementById("red-bar-mobile");
    RPGUI.set_value(progress, 0.8);

    var progress = document.getElementById("exp-bar-mobile");
    RPGUI.set_value(progress, 0.7);

    var progress = document.getElementById("sleep-bar-mobile");
    RPGUI.set_value(progress, 0.2);
  ...
  function create_slider(elem) {
    ...
    (function (
      ...
      function _onchange() {
        ...
        thumb.style.left =
          Math.floor(edges_width * 0.25) + relative_val * step + "px";
      }
